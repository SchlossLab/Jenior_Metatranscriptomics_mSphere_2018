...
**Figure 4 | Impact of antibiotic pretreatment and *C. difficile* infection on cecal metabolome** NMDS ordinations of Bray-Curtis distances comparing the dissimilarity of infection groups within each antibiotic pretreatment; **(a)** Streptomycin, **(b)** Cefoperazone, and **(c)** Clindamycin. Significant differences were determined by AMOVA. Relative concentrations of metabolites with highest Mean Decrease Accuracy (MDA) from Random Forest feature selection to discriminate between Mock and *C. difficile*-infected conditions within each antibiotic pretreatment; **(d)** Streptomycin, **(e)** Cefoperazone, and **(f)** Clindamycin. Significant differences are labeled along the right axis and were calculated with Wilcoxon rank-sum test with Benjamini-Hochberg correction (\*\*\* < 0.001, \*\* <= 0.01, \* <= 0.05).

**Figure 5 | ** metatranscriptome correlation with metabolome
**(a)** heatmap?
...
if i have time...
Figure 6 - individual taxa impact transcriptome linked to metabolome more
...
**Supplementary Figure 5 | CONCOCT clustering**
