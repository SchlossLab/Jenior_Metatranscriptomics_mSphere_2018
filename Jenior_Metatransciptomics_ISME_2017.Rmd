...
These data revealed distinct changes in expression for underrepresented genera for each antibiotic pretreatment between infections conditions. First, in streptomycin-pretreated mice, a large number of genes belonging to *Lactobacillus* were upregulated in *C. difficile* infection (Fig. 3a)
Next, in cefoperazone pretreatment primarily genes belonging to *Allistipes* and *Bacteroides* were upregulated in mock infection.



These results coresponded to 16S results by...


The presence of Archeael sequences in our shotgun sequencing data was not surprising as the universal 16S rRNA gene V4 region primers we used do not reliably amplify Archeae.
