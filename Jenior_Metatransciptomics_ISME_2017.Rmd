...
We then moved on to a more fine-scale resolution analysis and quantified expression changes at the individual gene annotation level. Similar to the pathway-level analysis, transcription for gene homologs between species was pooled to 

(Fig. 2b-d)
In agreement with pathway-level differences in expression, 



important to note that these groups are evenly subsampled, its just that the community is more transcriptionally active in cefoperazone mock infection
