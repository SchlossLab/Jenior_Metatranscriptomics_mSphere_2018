...
***C. difficile* colonization also corresponds to significant changes in the cecal metabolome.**
...
**Figure 4 | Impact of antibiotic pretreatment and *C. difficile* infection on cecal metabolome** NMDS ordinations of Bray-Curtis distances comparing the dissimilarity of pretreatment and infection groups. **(a)** Antibiotic-pretreated compared to Untreated controls and **(b)** comparison between only antibiotic pretreatment groups. **(c-e)** Within antibiotic pretreatment comparisons for the effect of *C. difficile* colonization on community structure. Significant differences and correlation coefficients for ordination analyses were found using ANOSIM. **(f)** Top 6 metabolites with highest mean decrease accuracy in each pretreatment group from Random Forest feature selection that differentiate mock and infected conditions.





**Figure 5 | Validation of whole community metabolic modeling algorithm** Change in metabolite score vs change in concentration
**(a)** Pooled analysis of all groups
**(b)** Streptomycin pretreatment
**(c)** Cefoperazone pretreatment
**(d)** Clindamycin pretreatment
