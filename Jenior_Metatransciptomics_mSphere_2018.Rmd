...
Specific transcriptomic chnges in the minority bacterial taxa
...
However, infection did not provide for the same level of discrimination in clindamycin-pretreated mice (Fig. 4F, Out-of-bag error = 5.56%). 
