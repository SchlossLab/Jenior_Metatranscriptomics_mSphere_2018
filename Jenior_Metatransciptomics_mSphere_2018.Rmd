...
**Figure 2 | Both cecal community structure and metabolomes significantly differ between antibiotic pretreatments that go on to 
 clear *C. difficile* colonization and those that do not.**

**(A)** NMDS ordination of Bray-Curtis distances between OTU relative abundances from colonized and cleared mice. 

**(B)** Relative abundance of OTUs included the optimal model generated by AUCRF discriminating colonized and cleared mice cecal microbitoa.

**(C)** NMDS ordination of Bray-Curtis distances between metabolites abundances from colonized and cleared mice.
**(D)** Scaled intensity of metabolites included the optimal model generated by AUCRF discriminating colonized and cleared mice cecal microbitoa.

Differences for ordinations calculated using AMOVA (*p* < 0.001).
