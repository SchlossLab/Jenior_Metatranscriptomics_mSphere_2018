...
However, infection did not provide for the same level of discrimination in clindamycin-pretreated mice (Fig. 4F, Out-of-bag error = 5.56%). Only 5-aminovalerate appeared in more than one list as an optimal discriminatory metabolite so we compared its change in relative concentration in all pretreatments (Fig. 4G). This molecule is a known byproduct of D-proline Stickland fermentation by *C. difficile* [@Bouillaut2013;@Neumann-Schaal2015]. Presence of 5-aminovalerate appears to be dependent on bacterial processes as its relative concentrations were significantly lower in ceca of antibiotic-pretreated, mock-infected animals. Conversely, it was found to be highly abundant in most infected animals compared to both susceptible and resistant controls. Only in clindamycin-pretreatment, where CDI was quickly cleared, did the concentration of 5-aminovalerate remain near undetectable in a subset of samples. *C. difficile* is able to catabolize proline along with glycine through a set of paired biochemical reactions known as Stickland fermentation. Along these lines, proline and 3 proline-conjugated amino acids were all significantly decreased during infection (Fig. S3B; *p* < `r infection_pvalues`). These combined results demonstrated that while distinct metabolic challenges may exist in each susceptible metabolome, Stickland fermentation could be a preferred energy acquisition pathway for *C. difficile* *in vivo*. 
