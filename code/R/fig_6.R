...
axis(1, at=seq(0,12,2), label=seq(0,12,2), cex=1.2)
axis(2, at=seq(0,12,2), label=seq(0,12,2), cex=1.2, las=1)
minor.ticks.axis(1, 10, mn=0, mx=12)
minor.ticks.axis(2, 10, mn=0, mx=12)
mtext(expression(paste('Normalized cDNA Abundance (',log[2],')')), side=1, padj=2.5, cex=0.9)
mtext('Mock-Infected', side=1, padj=3.7, font=2)
mtext(expression(paste('Normalized cDNA Abundance (',log[2],')')), side=2, padj=-2, cex=0.9)
