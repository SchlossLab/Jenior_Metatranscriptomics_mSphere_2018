...
bile_metabolome <- cbind(subset(metabolome, SUB_PATHWAY == 'Primary_Bile_Acid_Metabolism'),
...
points(x=metabolome_cefoperazone$MDS1, y=metabolome_cefoperazone$MDS2, bg='chartreuse3', pch=21, cex=1.7, lwd=1.2)
points(x=metabolome_clindamycin$MDS1, y=metabolome_clindamycin$MDS2, bg='blue2', pch=21, cex=1.7, lwd=1.2)
points(x=metabolome_streptomycin$MDS1, y=metabolome_streptomycin$MDS2, bg='firebrick1', pch=21, cex=1.7, lwd=1.2)
points(x=metabolome_germfree$MDS1, y=metabolome_germfree$MDS2, bg='gold1', pch=21, cex=1.7, lwd=1.2)
points(x=metabolome_untreated$MDS1, y=metabolome_untreated$MDS2, bg='azure2', pch=21, cex=1.7, lwd=1.2)
