...
# Output plot name
plot_ac <- 'results/supplement/figures/figure_S2ac.pdf'
metabolome_plot <- 'results/supplement/figures/figure_S2d.pdf'
otu_plot <- 'results/supplement/figures/figure_S2b.pdf'
